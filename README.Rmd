...
The goal of `mrf2dbayes` is to provide out-of-the-box implementations of Bayesian inference algorithms for Markov Random Fields on 2-dimensional lattices with pairwise interactions. It can be viewed as a Bayesian extension of the [`mrf2d`](https://github.com/Freguglia/mrf2d) package.
